...
import { UpdateQuestionRequestDTO, UpdateQuestionResponseDTO } from '../../business/dtos/update-question.dto';
import { PutQuestionRequest, PutQuestionResponse } from './dtos/put-questions.request';

export default class QuestionsHttpRepository implements IQuestionsHttpRepository  {
    ...
    public update = async (questionId: string, updateQuestionRequest: UpdateQuestionRequestDTO): Promise<Result<UpdateQuestionResponseDTO>> => {
