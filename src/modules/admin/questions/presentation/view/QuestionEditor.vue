    ...
    <div>
      <ConstructorItemLayout :label="presenter.labels.answers">
        ...
        >
          ...
          />
          <button
            class="ml-2 p-1 text-gray-400 cursor-pointer"
        ...
        <div class="flex justify-end mt-4">
          <button
            class="bg-purple-500 text-[#FFFFFF] px-4 py-2 rounded"
